...
def compile_model(
    ...
    _log_module_params("Filterer", filter_cfg)
    ...
    agg = Aggregation(encoder.embed_dim).to(device)
    ...
    target_filterer = copy.deepcopy(filterer)
    
    return encoder, filterer, target_filterer, agg, latent_predictor, action_predictor